...
const firebaseConfig = {
  apiKey: "AIzaSyAjNbq0kxZKElqPO7MY82VfdGrzLKKW5oU",
  authDomain: "file-sharing-app-7f7c0.firebaseapp.com",
  projectId: "file-sharing-app-7f7c0",
  storageBucket: "file-sharing-app-7f7c0.appspot.com",
  messagingSenderId: "95052830156",
  appId: "1:95052830156:web:dbc267b5c99316459ab969"
};
  ...
  return (
    <div className="Maindiv">
      ...
      <div className="MobileViewOnly">
        <p>
Easily share files online now.</p>
        <p>
          with just a{" "}
      ...
      <div className="Appcontainer">
        <div className="LeftSide">
          <div className="TextContainer" style={{ marginTop: "-20%" }}>
            ...
            Easily share files online now.{" "}
            </h2>
            <AnimatedGradientText className="textclass2" style={{ marginLeft: "0%" }}>
                Share files online using 5-digit code.
            </AnimatedGradientText>
            <p style={{ fontSize: "18px", fontWeight: "bold" }} className="textclass3">
              No sign-up, email, or phone number required.
            </p>
          </div>
        </div>
